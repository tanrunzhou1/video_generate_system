...
Revision ID: 455512264750
Revises: 
Create Date: 2026-05-29 11:44:15.110460
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_bgm_asset_project_id'), 'bgm_asset', ['project_id'], unique=False)
    ...
    op.create_index(op.f('ix_character_profile_project_id'), 'character_profile', ['project_id'], unique=False)
    op.create_table('final_video',
    sa.Column('id', sa.String(length=64), nullable=False),
    sa.Column('project_id', sa.String(length=64), nullable=False),
    ...
    op.create_index(op.f('ix_final_video_project_id'), 'final_video', ['project_id'], unique=False)
    ...
    op.create_index(op.f('ix_render_task_project_id'), 'render_task', ['project_id'], unique=False)
    op.create_table('script_scene',
    sa.Column('id', sa.String(length=64), nullable=False),
    sa.Column('project_id', sa.String(length=64), nullable=False),
    ...
    op.create_index(op.f('ix_script_scene_project_id'), 'script_scene', ['project_id'], unique=False)
    op.create_table('shot_plan',
    sa.Column('id', sa.String(length=64), nullable=False),
    sa.Column('project_id', sa.String(length=64), nullable=False),
    ...
    op.create_index(op.f('ix_shot_plan_project_id'), 'shot_plan', ['project_id'], unique=False)
    op.create_index(op.f('ix_shot_plan_scene_id'), 'shot_plan', ['scene_id'], unique=False)
    op.create_table('subtitle_segment',
    sa.Column('id', sa.String(length=64), nullable=False),
    sa.Column('project_id', sa.String(length=64), nullable=False),
    ...
    op.create_index(op.f('ix_subtitle_segment_project_id'), 'subtitle_segment', ['project_id'], unique=False)
    op.create_index(op.f('ix_subtitle_segment_shot_id'), 'subtitle_segment', ['shot_id'], unique=False)
    op.create_table('visual_asset',
    sa.Column('id', sa.String(length=64), nullable=False),
    sa.Column('project_id', sa.String(length=64), nullable=False),
    sa.Column('shot_id', sa.String(length=64), nullable=False),
    ...
    op.create_index(op.f('ix_visual_asset_shot_id'), 'visual_asset', ['shot_id'], unique=False)
    op.create_table('voice_asset',
    sa.Column('id', sa.String(length=64), nullable=False),
    sa.Column('project_id', sa.String(length=64), nullable=False),
    sa.Column('shot_id', sa.String(length=64), nullable=False),
    ...
    op.create_index(op.f('ix_voice_asset_character_id'), 'voice_asset', ['character_id'], unique=False)
    op.create_index(op.f('ix_voice_asset_project_id'), 'voice_asset', ['project_id'], unique=False)
    op.create_index(op.f('ix_voice_asset_shot_id'), 'voice_asset', ['shot_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_voice_asset_shot_id'), table_name='voice_asset')
    op.drop_index(op.f('ix_voice_asset_project_id'), table_name='voice_asset')
    op.drop_index(op.f('ix_voice_asset_character_id'), table_name='voice_asset')
    op.drop_table('voice_asset')
    op.drop_index(op.f('ix_visual_asset_shot_id'), table_name='visual_asset')
    op.drop_index(op.f('ix_visual_asset_project_id'), table_name='visual_asset')
    op.drop_table('visual_asset')
    op.drop_index(op.f('ix_subtitle_segment_shot_id'), table_name='subtitle_segment')
    op.drop_index(op.f('ix_subtitle_segment_project_id'), table_name='subtitle_segment')
    op.drop_table('subtitle_segment')
    op.drop_index(op.f('ix_shot_plan_scene_id'), table_name='shot_plan')
    op.drop_index(op.f('ix_shot_plan_project_id'), table_name='shot_plan')
    op.drop_table('shot_plan')
    op.drop_index(op.f('ix_script_scene_project_id'), table_name='script_scene')
    op.drop_table('script_scene')
    op.drop_index(op.f('ix_render_task_project_id'), table_name='render_task')
    op.drop_table('render_task')
    op.drop_index(op.f('ix_final_video_project_id'), table_name='final_video')
    op.drop_table('final_video')
    op.drop_index(op.f('ix_character_profile_project_id'), table_name='character_profile')
    op.drop_table('character_profile')
    op.drop_index(op.f('ix_bgm_asset_project_id'), table_name='bgm_asset')
